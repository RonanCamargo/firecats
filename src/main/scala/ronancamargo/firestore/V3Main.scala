...
import ronancamargo.firestore.codec.{FirestoreDecoder, FirestoreEncoder, FirestoreFieldEncoder}
import ronancamargo.firestore.data.Reference._
import ronancamargo.firestore.data.safe.DocumentDepthCoproduct.DocumentDepth1
import ronancamargo.firestore.safe.FirestoreIORepository
import ronancamargo.firestore.syntax.codec._
